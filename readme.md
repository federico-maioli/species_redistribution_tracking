...
This repository contains all files related to the analysis and manuscript preparation for the project. Below is a brief description of the main folders and their contents:
...
Contains the LaTeX files used for writing the manuscript. This includes the main text, sections, references, and any formatting needed for the final document.
 ...
 - `renv/`
Used to manage the project’s R environment. This ensures reproducibility by specifying the exact package versions used in the analysis.
