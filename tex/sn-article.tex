...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{output/figures/supp/pp.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{output/figures/supp/priors.png}
    \caption{}
    \label{fig:priors}
\end{figure}
