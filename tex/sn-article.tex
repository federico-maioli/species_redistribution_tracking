...
Despite widespread niche warming, the relationship between spatial shifts and thermal exposure varied among regions (Supplementary Fig~\ref{fig:corr_shifts_supp}). In some regions, as generally expected species that shifted poleward or deeper experienced weaker increases in thermal-niche temperatures. For instance in the NEUS-SS (posterior rho -0.88) CBS (-0.85) and NS (-0.81) and EBS (-0.63). Depth was for GOM (-0.79), BC (-0.72), and NS (-0.69). while longitude not really.
, suggesting partial avoidance of warming, whereas in others spatial shifts were unrelated to—or even positively associated with—niche warming. in some regions we found shifts to co-vary for instance in the in the BC, USWC NEUS-SS and GOM latitudinal shifts and longitudianl shifts were associated, generally folowing the coastile. in the NS latitudianl shift were associated with depth shifts 

\rho_depthnichec_thermalnichec_BAL
