...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.7]{output/images/map.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.58]{output/images/slopes.png}
...
\begin{figure}[h]
    \centering
        \includegraphics[scale=0.6]{output/images/pca.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{output/images/win_lose.png}
    \caption{
...
\begin{figure}[h]
    \centering
        \includegraphics[scale=0.7]{output/images/prior_checks.png}
...
\begin{figure}[h]
    \centering
        \includegraphics[scale=0.7]{output/images/shrinkage_slopes.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[scale=.65]{output//images/prop_sign.png}
...
\begin{figure}[h]
    \centering
        \includegraphics[scale=0.6]{output/images/loadings.png}
