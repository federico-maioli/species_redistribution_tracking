...
command <- paste(
  ...
  "--end-datetime 2021-06-01T00:00:00",
  ...
  "-o /Users/fedma/Library/CloudStorage/OneDrive-DanmarksTekniskeUniversitet/postdoc_dtu/species_redistribution_tracking/data/environmental/temperature/",
  sep = " "
)
